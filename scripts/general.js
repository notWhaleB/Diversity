var DIVERSITY_APP_HOME = 0, DIVERSITY_APP_ESOTERIC = 1, DIVERSITY_APP_WORDSCHEAT = 2, DIVERSITY_APP_THREE = 3,
...
function Diversity() {
    ...
    this.path = ["data/home/", "data/esoteric/", "data/wordscheat/", "", "", "data/tactris/", "data/floodit/", "data/beehive/"];
    ...
    this.run_app = function(id, animate) {
        if (id == DIVERSITY_APP_THREE || id == DIVERSITY_APP_FOUR || id == DIVERSITY_APP_EIGHT) {
